...
#' @param type_of_window Default="sentence". Two alternative values, "sentence" or "length". "length" means that you want to divide the text with exactly the length of words. 'sentence' means that while dividing the windows, the function never break a sentence in the middle point but finish the sentences instead.
#' @param window_length Integer, While type_of_window="length", it will divided the text with the length of exactly this value. Here you could set the length of windows=1 and type_of_window="length" to seperate the text with each sentence
...
#'
#' @return A dataset, which includes the speed, volume and circuitousness of the text.
#' @export
#'
#' @examples
#' library(rStoryShape)
